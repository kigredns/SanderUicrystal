...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(227, 0, 249),
			Divider = Color3.fromRGB(60, 60, 60),
			Text = Color3.fromRGB(227, 0, 249),
			TextDark = Color3.fromRGB(227, 0, 249)
		}
	},
...
CreateElement("Label", function(Text, TextSize, Transparency)
	local Label = Create("TextLabel", {
		Text = Text or "",
		TextColor3 = Color3.fromRGB(227, 0, 249),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(0, 0, 0), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(227, 0, 249), 1.2),
			MakeElement("Padding", 12, 12, 12, 12),
			SetProps(MakeElement("Image", NotificationConfig.Image), {
				Size = UDim2.new(0, 20, 0, 20),
				ImageColor3 = Color3.fromRGB(227, 0, 249),
				Name = "Icon"
			}),
